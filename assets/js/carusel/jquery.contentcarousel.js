(function($) {
	var	aux		= {
			...
			navigate	: function( dir, $el, $wrapper, opts, cache ) {
				...
				if( cache.expanded ) {
					scroll		= 2; // scroll is always 1 in full mode
			...
			openItem	: function( $wrapper, $item, opts, cache ) {
				...
				// the item's position (1, 2, or 4) on the viewport (the visible items) 
			...
			// gets the item's position (1, 2, or 4) on the viewport (the visible items)
			// val is the left of the item
			getWinPos	: function( val, cache ) {
				switch( val ) {
					case 0 					: return 1; break;
					case cache.itemW 		: return 2; break;
					case cache.itemW * 2 	: return 4; break;
				}
			}
		},
		methods = {
